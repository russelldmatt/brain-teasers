...
def loop(possibilities, all_possibilities, n, verbose):
    ...
    return loop(new_possibilies, all_possibilities, n+1, verbose)
...
def test(N, verbose):
    ...
    possibilities = all_
    num_guesses = loop(possibilities, all_, 0, verbose)
