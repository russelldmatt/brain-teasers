...
$$prob\_lte(5, 22, 16) \approx 0.55$$, meaning that if there was absolutly no connection between one election and the next, the probability that the longest consecutive sequence of wins by either political party of 5 terms or less is about 55%.  Null hypothesis not rejected...
